...
func (s *accountRepoStub) ReadSchedulerFreshness(ctx context.Context, ids []int64) (map[int64]SchedulerFreshness, error) {
	panic("unexpected ReadSchedulerFreshness call")
}
