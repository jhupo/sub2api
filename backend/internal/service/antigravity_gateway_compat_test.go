...
func TestBuildAntigravityCompatGeminiBody_DropsMixedBuiltInTools(t *testing.T) {
...
func TestAntigravityCompatChatMixedBuiltInToolsAreDropped(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	require.False(t, gjson.GetBytes(requestBody, "request.toolConfig.includeServerSideToolInvocations").Bool())
	...
	require.False(t, gjson.GetBytes(requestBody, "request.tools.1.codeExecution").Exists())
}
