...
func TestDefaultCodexSynthInstructionsModelAware(t *testing.T) {
	...
	require.True(t, strings.Contains(defaultCodexSynthInstructions("gpt-6-astra"), "You are Codex, an agent based on GPT-6"))
	require.True(t, strings.Contains(defaultCodexSynthInstructions("gpt-5.6-sol"), "You are Codex, an agent based on GPT-5"))
	require.True(t, strings.Contains(defaultCodexSynthInstructions("global.openai.gpt-5.6-terra"), "You are Codex, an agent based on GPT-5"))
	require.True(t, strings.Contains(defaultCodexSynthInstructions("gpt-5.6-codex"), "You are Codex, based on GPT-5"))
