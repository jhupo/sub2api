...
func (s *PaymentService) sendSubscriptionPurchaseSuccessNotification(ctx context.Context, o *dbent.PaymentOrder) error {
	...
	if o.FulfilledSubscriptionID != nil && s.subscriptionSvc != nil {
		if sub, err := s.subscriptionSvc.GetByID(ctx, *o.FulfilledSubscriptionID); err == nil {
...
func (s *PaymentService) ExecuteSubscriptionFulfillment(ctx context.Context, oid int64) error {
	...
	if o.PlanID == nil || o.PlanVersionID == nil {
...
func (s *PaymentService) ensurePaymentSubscriptionAssigned(ctx context.Context, o *dbent.PaymentOrder) error {
	...
	if _, err := txClient.PaymentAuditLog.Create().
		...
		SetDetail(string(detail)).SetOperator("system").Save(txCtx); err != nil {
