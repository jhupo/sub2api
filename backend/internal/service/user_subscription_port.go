...
type UserSubscriptionRepository interface {
	...
	GetByUserIDAndPlanVersionID(ctx context.Context, userID, planVersionID int64) (*UserSubscription, error)
	...
	ExistsActiveByUserIDAndPlanVersionID(ctx context.Context, userID, planVersionID int64) (bool, error)
