...
type SubscriptionPlanQuery struct {
	...
	withVersions      *SubscriptionPlanVersionQuery
...
func (_q *SubscriptionPlanQuery) QueryVersions() *SubscriptionPlanVersionQuery {
...
func (_q *SubscriptionPlanQuery) WithVersions(opts ...func(*SubscriptionPlanVersionQuery)) *SubscriptionPlanQuery {
	query := (&SubscriptionPlanVersionClient{config: _q.config}).Query()
...
func (_q *SubscriptionPlanQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SubscriptionPlan, error) {
	...
	if query := _q.withVersions; query != nil {
		if err := _q.loadVersions(ctx, query, nodes,
			func(n *SubscriptionPlan) { n.Edges.Versions = []*SubscriptionPlanVersion{} },
			func(n *SubscriptionPlan, e *SubscriptionPlanVersion) { n.Edges.Versions = append(n.Edges.Versions, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *SubscriptionPlanQuery) loadVersions(ctx context.Context, query *SubscriptionPlanVersionQuery, nodes []*SubscriptionPlan, init func(*SubscriptionPlan), assign func(*SubscriptionPlan, *SubscriptionPlanVersion)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(subscriptionplanversion.FieldPlanID)
	}
	query.Where(predicate.SubscriptionPlanVersion(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(subscriptionplan.VersionsColumn), fks...))
	}))
