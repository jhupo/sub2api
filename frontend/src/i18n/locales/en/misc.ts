export default {
  ...
  version: {
    ...
    updateVerifying: 'Verifying the new version',
    rollbackVerifying: 'Verifying the rollback version',
    rolloutPending: 'The service will restart briefly and completes only after the running version is confirmed.',
    rolloutOperationMissing: 'The server did not return an operation ID, so the rollout cannot be confirmed.',
    rolloutRolledBack: 'The target did not become ready and the previous version was restored.',
    rolloutFailed: 'The rollout failed. Check the update logs before retrying.',
  ...
  payment: {
    ...
    admin: {
      ...
      endDate: 'End date',
      applyDateRange: 'View statistics',
      dateRangeHint: 'Uses the site timezone and includes both the start and end dates.',
      dateRangeRequired: 'Select a start and end date',
