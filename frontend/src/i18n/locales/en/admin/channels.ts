export default {
    ...
    channels: {
      ...
      noGroupsSelected: 'No groups selected for the {platform} platform',
      emptyModelsInPricing: 'A pricing entry for the {platform} platform has no models selected',
      ...
      form: {
        ...
        modelPricingSelectionHint: 'Click a model to view its built-in default prices',
        defaultPricingLoading: 'Loading built-in default prices…',
        defaultPricingLoaded: 'Empty price fields show this model\'s built-in defaults. Entered values override the corresponding prices for every model in this entry.',
        defaultPricingUnavailable: 'No built-in default pricing is available for this model.',
        builtInDefaultPrice: 'Built-in {price}',
        billingMode: 'Billing Mode',
