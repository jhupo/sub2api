export default {
  ...
  "webshareHint": "Only active State-refresh SSE requests use Webshare. Each refresh opens one proxy connection and uses p.webshare.io:80 with -rotate to obtain one new residential exit. Normal traffic keeps the account's existing egress.",
  ...
  "cacheHint": "Only digests are shown. Up to 4096 entries are retained. Expired or cleared states are collected again from normal responses.",
  "clearAll": "Clear all",
  "disabled": "Disabled. No automatic collection or reuse.",
  "loading": "Loading states…",
  "empty": "No cached states. After enabling, normal responses can populate this list when a matching-length state is received.",
  ...
  "clearConfirm": "Clear this entry? Normal responses can collect it again.",
  "clearAllConfirm": "Clear all entries? Normal responses can collect them again.",
