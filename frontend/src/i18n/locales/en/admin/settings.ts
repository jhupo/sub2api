export default {
    settings: {
      upstreamState: {
  "retryIntervalInvalid": "Retry interval must be an integer from 1 to 60 minutes.",
  "retryIntervalHint": "1–60 minutes, default 5, measured from refresh completion. The next attempt also waits for the minute scan and queue. Newly acquired States already inside the rotation window use this delay too, preventing repeated immediate refreshes.",
  "retryInterval": "Failed refresh retry interval (minutes)",
  "rotationLeadInvalid": "Rotation lead must be an integer from 0 to 30 minutes.",
  "rotationLeadHint": "0–30 minutes, default 10. For timestamped States, refresh before estimated expiry or at the rotation interval, whichever comes first. Zero disables the lead. States without a timestamp rotate at the configured interval.",
  "rotationLead": "Rotation lead (minutes)",
  "title": "State management",
  "description": "Maintain one X-Codex-Turn-State per OpenAI OAuth account and final upstream model, with manual entry, immediate refresh, and automatic replacement near expiry.",
  "back": "Back to feature settings",
  "configure": "Open state management",
  "refresh": "Refresh list",
  "settings": "Collection and reuse",
  "scopeHint": "State is collected and reused by OpenAI OAuth account and final upstream model. Different models on the same account are managed separately.",
  "enabled": "Enable state management",
  "enabledHint": "Off by default. When enabled, State management appears in the sidebar. Turning it off hides the page and restores normal forwarding.",
  "ttl": "Automatic rotation interval (minutes)",
  "ttlHint": "1–60 minutes, default 40. Each successful acquisition starts a new cycle. At the end of the cycle, queue a refresh; a parsed expiry with its lead may trigger it sooner. Changes apply to existing States.",
  "length": "Expected state length (bytes)",
  "lengthHint": "Default 292. Only values passing length and format checks are accepted. Mismatches do not replace a saved State. Length alone does not establish model quality.",
  "ttlInvalid": "Automatic rotation interval must be an integer from 1 to 60 minutes.",
  "lengthInvalid": "The expected State length must be an integer from 1 to 8192.",
  "autoReplace": "Automatically replace State",
  "autoReplaceHint": "Only enabled account/model pairs are processed. Checked every minute: missing States, completed rotation cycles or States within {lead} minutes of estimated expiry enter the serial queue. Failures wait {retry} minutes before queuing again, with no attempt limit. Unexpired States are retained on failure. Manual refresh bypasses the automatic switch and retry delay.",
  "autoReplaceOn": "Automatic replacement enabled",
  "autoReplaceOff": "Automatic replacement disabled",
  "webshareEnabled": "Use Webshare Rotating Residential for State refreshes",
  "webshareHint": "Only active State-refresh SSE requests use Webshare. Each refresh randomly selects one credential using single-item pages, then sends one request through p.webshare.io:80. Normal traffic keeps the account's existing egress.",
  "webshareApiKey": "Webshare Token API Key",
  "webshareApiKeyHint": "Used as Authorization: Token. It is stored but never returned. Leave blank to keep the saved key.",
  "webshareKeyConfigured": "Configured; leave blank to keep it",
  "webshareKeyPlaceholder": "Paste the Webshare Token API Key",
  "webshareKeyRequired": "Configure a Webshare API Key before enabling Webshare refreshes.",
  "webshareCountryMode": "Exit country mode",
  "webshareCountryRandom": "Global random",
  "webshareCountrySpecified": "Specified country pool",
  "webshareCountryModeHint": "Global mode samples proxy entries uniformly, not countries. Specified mode first samples a configured country uniformly, then one of its entries. A different exit IP is not guaranteed.",
  "webshareCountries": "Country codes",
  "webshareCountriesHint": "Enter ISO 3166-1 two-letter codes separated by commas or spaces, for example US, JP, DE.",
  "webshareCountriesInvalid": "The specified country pool needs at least one valid two-letter country code.",
  "saveHint": "Disabling management or changing the expected length clears the cache. Rotation interval, lead and retry timing apply at the next scheduling check without extending saved token validity. Settings synchronize across instances within about 3 seconds.",
  "save": "Save settings",
  "cached": "Cached states",
  "cacheHint": "Only digests are shown, with up to 4096 entries. Manual settings, explicit refreshes and automatic rotation update State; ordinary responses do not.",
  "clearAll": "Clear all",
  "disabled": "Disabled. No active refresh or reuse.",
  "loading": "Loading states…",
  "empty": "No cached states. Set State manually, refresh now, or enable automatic replacement to obtain one.",
  "unavailable": "The list is unavailable. Please refresh.",
  "account": "Account",
  "modelSession": "Upstream model",
  "summary": "State digest / length",
  "egress": "Collection egress",
  "acquired": "Collected",
  "remaining": "Remaining",
  "actions": "Actions",
  "proxy": "Proxy #{id}",
  ...
  "accounts": "Accounts",
  "models": "Models",
  "expiring": "Expiring within 5m",
  "loadFailed": "Could not load settings. Please refresh.",
  "listFailed": "Could not load states. Displayed data may be stale. Please refresh.",
  "saved": "State settings saved",
  "saveFailed": "Could not save. If another page changed the configuration, reload this page and retry.",
  "clearConfirm": "Clear this entry? Refresh it manually or let enabled automatic replacement obtain a new State.",
  "clearAllConfirm": "Clear all entries? Refresh them manually or let enabled automatic replacement obtain new States.",
  "clearFailed": "Could not clear states. Please retry.",
  "expired": "Expired",
  "matrix": "OAuth accounts and models",
  "matrixHint": "Opt in separately for each account and final upstream model. Models come from the existing catalog and account mappings, not verified entitlements. Disabling one pair clears only that account and model state.",
  "model": "Upstream model",
  "pairEnabled": "Enable replacement",
  ...
  "missing": "No state returned",
  "invalid": "Invalid Fernet value",
  "poolTitle": "Account / model state pool",
  "poolHint": "Only validated States of {length} bytes are used. Rotate every {ttl} minutes after successful acquisition. For timestamped States, estimate expiry one hour after issue and refresh earlier if the expiry lead requires it. Failures retry at the interval configured in System Settings.",
  "upstreamExpiry": "Estimated expiry countdown",
  "issued": "Issued",
  "rotateAt": "Next rotation",
  "stateUnavailable": "No reusable state saved",
  "setState": "Set State",
  "setStateTitle": "Set X-Codex-Turn-State",
  "statePlaceholder": "Paste the complete gAAAAA… State",
  "stateInputHint": "Must be exactly {length} bytes. Expiry is estimated as one hour after a parseable Fernet issue timestamp.",
  "stateLength": "State length",
  "filterAccounts": "Filter accounts",
  "onlyEnabled": "Enabled replacements only",
  "noEnabledPairs": "No matching enabled pairs. Uncheck “Enabled replacements only” to view all accounts and models and enable replacement.",
  ...
  "expirySource": {
  "fernet": "Estimated from issue time",
  "fallback": "Fallback lifetime",
  },
  "stateSet": "State saved",
  "stateSetFailed": "Could not save State",
  "refreshNow": "Refresh now",
  "refreshSucceeded": "State refreshed from upstream",
  "refreshFailed": "Upstream State refresh failed",
  "lastRefreshError": "Last refresh failed",
  "status": {
    "normal": "Available",
    "extended": "Possibly degraded (+16B)",
    "mismatch": "Length mismatch",
    "missing": "Missing",
    "invalid": "Invalid",
    "expired": "Expired",
    ...
    "disabled": "Disabled"
      ...
      gatewayForwarding: {
        ...
        antigravityUserAgentVersionPlaceholder: '2.8.0',
