export default {
  ...
  keys: {
    ...
    selectPayment: 'Select payment source',
    walletPayment: 'Wallet balance',
    subscriptionPayment: 'Subscription',
    subscriptionFallback: 'Subscription #{id}',
    inactiveSubscription: 'Subscription #{id} (inactive)',
    subscriptionRequired: 'Select an active subscription',
    statusLabel: 'Status',
