export default {
    ...
    channels: {
      ...
      noGroupsSelected: '{platform} 平台尚未选择分组',
      emptyModelsInPricing: '{platform} 平台存在未选择模型的定价配置',
      ...
      form: {
        ...
        modelPricingSelectionHint: '点击模型可查看该模型的内置默认价格',
        defaultPricingLoading: '正在读取内置默认价格…',
        defaultPricingLoaded: '空白价格框中显示的是该模型的内置默认价格；手动填写会覆盖对应价格，并应用于本条配置内的全部模型。',
        defaultPricingUnavailable: '内置定价目录中暂无该模型的默认价格。',
        builtInDefaultPrice: '内置 {price}',
        billingMode: '计费模式',
    ...
    subscriptions: {
      ...
      selectUser: '选择用户',
      selectPlan: '选择套餐',
      planHint: '有效期和额度按套餐当前发布版本冻结到用户订阅',
      ...
      guide: {
        title: '订阅管理教程',
        subtitle: '套餐按时间周期为用户提供使用额度，支持日/周/月配额限制。按照以下步骤即可完成配置。',
        showGuide: '使用指南',
        step1: {
          title: '创建套餐',
          line1: '前往「套餐管理」页面，点击「新增套餐」',
          line2: '配置有效期以及日/周/月额度限制',
          line3: '发布套餐；后续修改额度会生成新版本，不影响已持有订阅',
          link: '前往套餐管理'
        },
        step2: {
          title: '分配订阅给用户',
