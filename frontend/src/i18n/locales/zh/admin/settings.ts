export default {
  ...
  "webshareHint": "仅主动刷新 State 的 SSE 请求使用 Webshare。每次刷新只建立一条代理连接，并通过 p.webshare.io:80 的 -rotate 模式获取一个新住宅出口；普通业务请求仍使用账号原有出口。",
  ...
  "save": "保存设置",
  "cached": "缓存状态",
  "cacheHint": "仅展示摘要，最多保存 4096 条；自然过期或清空后等待下一次正常业务响应采集。",
  "clearAll": "清空全部",
  "disabled": "功能未启用，未进行自动采集或复用。",
  "loading": "正在加载状态…",
  "empty": "暂无状态。开启后，正常请求返回长度匹配的 state 时会出现在这里。",
  ...
  "clearConfirm": "清空这条缓存？后续会从正常业务响应重新采集。",
  "clearAllConfirm": "清空全部缓存？后续会从正常业务响应重新采集。",
