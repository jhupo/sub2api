export default {
  ...
  version: {
    ...
    updating: '正在更新...',
    updateComplete: '更新完成',
    updateVerifying: '正在验证新版本',
    rollbackVerifying: '正在验证回退版本',
    rolloutPending: '服务将短暂重启，确认实际运行版本后才会显示完成',
    rolloutOperationMissing: '服务器未返回操作 ID，无法确认更新结果',
    rolloutRolledBack: '目标版本未通过就绪检查，已恢复到之前的版本',
    rolloutFailed: '发布失败，请先检查更新日志再重试',
    updateFailed: '更新失败',
  ...
  payment: {
    ...
    admin: {
      ...
      todayRevenue: '今日收入',
      customPeriod: '自定义',
      customDateRange: '自定义时间范围',
      startDate: '开始日期',
      endDate: '结束日期',
      applyDateRange: '查看统计',
      dateRangeHint: '按站点时区统计，包含开始和结束日期当天。',
      dateRangeRequired: '请选择开始和结束日期',
      dateRangeInvalid: '结束日期不能早于开始日期',
      selectedDateRange: '{start} 至 {end}',
      totalRevenue: '总收入',
      todayOrders: '今日订单',
      orderCount: '订单数',
      avgAmount: '平均金额',
