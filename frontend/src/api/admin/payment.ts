...
export type PaymentDashboardParams =
  | { days: number; start_date?: never; end_date?: never }
  | { days?: never; start_date: string; end_date: string }
...
export const adminPaymentAPI = {
  ...
  getDashboard(params: PaymentDashboardParams = { days: 30 }) {
